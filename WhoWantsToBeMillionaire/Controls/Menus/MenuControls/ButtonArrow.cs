...
namespace WhoWantsToBeMillionaire
{
    class ButtonArrow : PictureBox, IDisposable
    {
        ...
        public readonly DirectionButtonArrow DirectionArrow;

        public ButtonArrow(DirectionButtonArrow direction)
        {
            DirectionArrow = direction;
            Dock = direction == DirectionButtonArrow.Left ? DockStyle.Left : DockStyle.Right;
