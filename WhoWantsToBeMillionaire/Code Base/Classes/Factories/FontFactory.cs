...
namespace WhoWantsToBeMillionaire
{
    static class FontFactory
    {
        ...
        public static Font CreateFont(GameFonts font, float emSize, FontStyle style = FontStyle.Regular, GraphicsUnit unit = GraphicsUnit.Pixel)
        {
            return new Font(s_fontCollection.Families[(int)font], emSize, style, unit);
        }
