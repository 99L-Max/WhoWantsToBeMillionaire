...
{
    class ButtonWire : PictureBox, IDisposable, IResizable
    {
        private static readonly ReadOnlyDictionary<ButtonWireThemes, Image> s_imageButton;
        ...
        private ButtonWireThemes _theme;

        static ButtonWire()
        {
            s_imageButton = SpritePainter.GetEnumSpritesList<ButtonWireThemes>(Resources.ButtonWire);
        ...
        {
            var sizeImage = s_imageButton[ButtonWireThemes.Blue].Size;
        ...
        { 
            SetStyle(ButtonWireThemes.Orange, Color.Black);
        }

        protected override void OnMouseLeave(EventArgs e)
        { 
            SetStyle(ButtonWireThemes.Blue, Color.White);
        }

        protected override void OnMouseDown(MouseEventArgs e)
        { 
            SetStyle(ButtonWireThemes.Green, Color.Black);
        }
        ...
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            if (Enabled)
                ...
                SetStyle(ButtonWireThemes.Gray, Color.Black);
        }

        private void SetStyle(ButtonWireThemes theme, Color foreColor)
        {
            _theme = theme;
