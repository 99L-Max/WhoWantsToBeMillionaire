...
namespace WhoWantsToBeMillionaire
{
    class LabelDialog : Label
    {
        ...
        {
            Dock = DockStyle.Fill;
            Font = FontFactory.CreateFont(GameFonts.Arial, sizeFont);
        ...
        private void DrawBack()
        {
            ...
            _backgroundText = PanelPainter.GetLinearGradientPanel(_frameRectangle.Size, _border, Color.Gainsboro, Color.SlateGray, 45f, Color.Navy, Color.Black, 90f);
