...
namespace WhoWantsToBeMillionaire
{
    static class Resizer
    {
        ...
        {
            return ResizeRectangle(rectangle, ratio, ratio);
        }
        ...
        public static Size Resize(BasicSizes basicSize, int size, int widthFraction, int heightFraction)
        {
            var result = new Size();

            if (basicSize == BasicSizes.Width)
            {
                result.Width = size;
        ...
        {
            return Resize(size, ratio, ratio);
        }
