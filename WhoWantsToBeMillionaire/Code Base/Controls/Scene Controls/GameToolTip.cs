...
namespace WhoWantsToBeMillionaire
{
    class GameToolTip : ToolTip, IDisposable
    {
        ...
        {
            _font = FontFactory.CreateFont(GameFonts.Arial, fontSize, FontStyle.Bold);
            _clientRectangle = new Rectangle(0, 0, width, height);
            _textRectangle = Resizer.ResizeRectangle(_clientRectangle, border);
            _background = PanelPainter.GetLinearGradientPanel(_clientRectangle.Size, border, Color.Gainsboro, Color.SlateGray, 45f, Color.Navy, Color.Black, 90f);
